    ...
    >
      <div class="relative w-full  max-h-full" :class="props.sizeModal">
        ...
        <div class="relative bg-white rounded-lg shadow">
          ...
          <!-- Modal body -->
          <div class="p-10 space-y-6 mt-4 mb-4 flex justify-center items-center flex-col text-center">
            <img
            src="~/assets/playground_assets/icon_modal_delete.svg?url"
          />
          <h1 style="color: #414552; font-size: 24px; font-weight: 500;">Are you sure delete {{props.title}}?</h1>
          <p style="color: #95969B">Do you really want to delete these {{props.title}}? This process cannot be undone.</p>
          </div>
          <!-- Modal footer -->
          <div 
          ...
          >
            ...
            @click="submitForm()"
              type="button"
              class="text-white bg-[#CD3D64] hover:bg-[#bd4464] focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-md text-sm px-5 py-2.5 text-center"
            >
              Yes, Delete
            </button>
          </div>
